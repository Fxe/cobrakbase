...
class ExpressionMatrix(FloatMatrix2D):
    ...
    def __init__(self, data, scale, matrix_type, genome_ref=None, feature_mapping=None, description=None,
    ...
    def from_dict(data, info=None, args=None):
        ...
        return ExpressionMatrix(matrix_data, data['scale'], data['type'], genome_ref, feature_mapping, description,
